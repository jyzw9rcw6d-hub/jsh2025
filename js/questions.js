const questions = [
{id:1,category:"血圧評価・診断",difficulty:"★★★★★",question:"診察室血圧154/92mmHg、家庭血圧128/78mmHgで、日内変動評価でも夜間血圧低下を認める。臓器障害は認めない。こ���患者への対応として最も適切なのは？",choices:["直ちに2剤併用降圧療法を開始する","白衣高血圧として経過観察のみとする","生活習慣修正を行いながら定期的評価を行う","仮面高血圧として強力な降圧治療を行う"],answer:2,explanation:"診察室血圧のみ高値で家庭血圧が正常の場合、白衣高血圧を考える。ただし将来的な高血圧発症リスクがあるため、生活習慣改善と定期的評価が重要である。"},
